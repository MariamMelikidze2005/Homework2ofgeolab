...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"your Balance {BAT}");

    }

    static void InputOfProcess(Func<decimal, bool> process)
    {
        string answer;

        do
        {
            Console.Write("Do you want to continue yes or y? : ");
    ...
    static decimal BankAccountTransactions()
    {
        ...
        InputOfProcess(amount =>
        {
            Console.Write("(income/expense): ");
